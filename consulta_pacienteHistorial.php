...
$SQL="select * from atributos_cardiovascular a, historial h where paciente='$id' and a.id_historial=$id_historial and h.id_historial=$id_historial order by a.id_historial desc limit 1";
